...
bool strzelFlare = false;
bool strzelPlasma = false;
bool razor = false;
bool cbore = false;
bool usypiacz = false;
bool nuke = false;
...
/*
int __cdecl sub_4402D0(int, int, int, int, int);
int sub_43C210(void);

int __cdecl sub_41EAD0(int);
	int __cdecl sub_414160(int, int);
	int __cdecl sub_43ACB0(int);
	int __cdecl sub_41FF20(int, int, int);
	int __cdecl sub_451B00(int, int, int);
	int __cdecl sub_451E20(int, int, int);
	int __cdecl sub_432260(int);
	int __cdecl sub_43ACB0(int);
	int __cdecl sub_451070(int);
	int __cdecl sub_416750(int, int, int, int, int, int);
	int __cdecl sub_417AB0(int, int, int);
	int __cdecl sub_431F30(__int16, int, int, int, int, int);
	int __cdecl sub_43A180(int);
	int __cdecl sub_435650(int);
	int __cdecl sub_420480(int, int);
	int __cdecl sub_420390(int, int);
	int __cdecl sub_41FE50(int, int, int);
	int __cdecl sub_417390(int);
	int sub_4455E0(void);
	int __cdecl sub_421A00(int, int);
	int __cdecl sub_43ACB0(int);
	int __cdecl sub_4351F0(int, int, int, int);
	int __cdecl sub_451E20(int, int, int);
	int __cdecl sub_41A500(int, int, int, int, int);
	int __cdecl sub_4172A0(int, int, int, int);
	int __cdecl sub_41FFE0(int, int);
...
int __cdecl sub_471A30(int);
	...
	int sub_474240(void);
	int sub_432560(void);
	int __cdecl sub_471340(int);
	int __cdecl sub_47BD50(int);
	int sub_4455E0(void);
	int sub_445500(void);
	int sub_4477E0(void);
	int sub_4454E0(void);*/
...
/*hit:
	int __cdecl sub_45B350(int); -to sie wywołuje ciągle a te niższe tylko jak hit
	(int __cdecl sub_45B060(int); -to przy każdym strzale, a te niższe jak hit)
	int __cdecl sub_45C9E0(int);
		int __cdecl sub_449730(int, int, int, int, int, int, int, int, int);
			int __cdecl sub_44A7B0(int, int, int, int, int, int, int, int);
				int __cdecl sub_44A570(int, int, int, int, int, int, int, int, int, int, int);
					int __cdecl sub_416730(int, int, int);
						int __cdecl sub_417AB0(int, int, int);
							int __cdecl sub_41A500(int, int, int, int, int);
								0041A872 - ustawienie hp po hicie			*/
...
int hookedFunction2(char *text)
{
	...
	if (text[0] != ' ' || text[1] == '/') {
		...
		/*else if (command.find("drop weapon ") == 0) {
			...
			komunikat("You are looking for \"fixjump \" command. Other fps related commands are: \"frametime ?\" and \"fixgamespeed 1\"");
		}
			...
			komunikat("The default is -10.23999977");
		}
			...
			komunikat("The default is 0.08726646751");
		}
			...
			komunikat("The default is 0.1000000015");
		}
		...
		else if (command.find("bulletspeed ") == 0) {
			float f = atof(command.substr(12).c_str());
			WriteToMemory((LPVOID)0x00B64D70, &f, sizeof(f));
		} 
		else if (command.find("flare ") == 0) {
			flareToFire = atoi(command.substr(6).c_str());
			WriteToMemory((LPVOID)0x106D1BD9, "\x01", 1); 
			short s = 1;
			WriteToMemory((LPVOID)0x106D1BB2, &s, 2);
		}
		...
		else if (command.find("enablecustombulletspeed ") == 0) {
			int i = atoi(command.substr(24).c_str());
			if (i == 0) {
				WriteToMemory((void*)0x0046149C, "\xD8\x0D\xFC\xB7\x50\x00", 6);
			}
			else {
				WriteToMemory((void*)0x0046149C, "\xD8\x0D\x70\x4D\xB6\x00", 6); //thx to that you can set bullet/particless speed via 00B64D70 variable
			}
		}
		else if (command.find("fixedf ") == 0) {
...
void dodajAmmo(int weapon, int ammo) {
	...
	case 21: //nuke
		*((short*)0x106D1BB0) += ammo;
		break;
	case 26: //assault
		*((short*)0x106D1BB6) += ammo;
		break;
	case 30: //betaGrenade
		*((short*)0x106D1BBC) += ammo;
		break;
	case 31: //singlerocket
		*((short*)0x106D1BBE) += ammo;
		break;
	default:
		break;
	}
	...
	for (auto const& value : *v) {
		...
		case 21: //normal bow
			*((byte*)0x106D1BC4) = equip;
			...
			break;
		case 22: //assault
			*((byte*)0x106D1BDC) = equip;
			if (ammo >= 0) {
				*((short*)0x106D1BB6) = ammo;
			}
			else if (startingMaxAmmo)
				*((short*)0x106D1BB6) = 300;
			else
				*((short*)0x106D1BB6) = 100;
			id_broni = 31;
			break;
		case 24: //betaGrenade
			*((byte*)0x106D1BE0) = equip;
			if (ammo >= 0) {
				*((short*)0x106D1BBC) = ammo;
			}
			else if (startingMaxAmmo)
				*((short*)0x106D1BBC) = 100;
			else
				*((short*)0x106D1BBC) = 15;
			id_broni = 31;
			break;
		case 100: //non-explosive arrows
			if (ammo >= 0) {
				*((short*)0x106D1B84) = ammo;
			}
			else if (startingMaxAmmo) {
...
/*int hookedHitOrMiss1(int int1)
{
	int ret = hitOrMiss1(int1);
	cout << "hitOrMiss1(" << int1 << ") : " << ret << endl;
	return ret;
}

int hookedHitOrMiss2(int int1)
{
	int ret = hitOrMiss2(int1);
	cout << "hitOrMiss2(" << int1 << ") : " << ret << endl;
	return ret;
}*/
...
int hookedHitOrMiss3(int int1)
{
	int ret = hitOrMiss3(int1);
	if (param == int1) {
		cout << "hitOrMiss4(" << param << ") : " << rett << endl;
	}
	if(ret!=0)
		cout << "hitOrMiss3(" << int1 << ") : " << ret << endl;
	
	return ret;
}

int hookedHitOrMiss4(int int1)
{
	int ret = hitOrMiss4(int1);
	//if (true)
		//cout << "hitOrMiss4(" << int1 << ") : " << ret << endl;
	param = int1;
	rett = ret;
...
int hookedHit(int int1)
{
	int ret = hit(int1);
	cout << "hit(" << int1 << ") : " << ret << endl;
	return ret;
}

int hookedMiss(int int1)
{
	int ret = miss(int1);
	cout << "miss(" << int1 << ") : " << ret << endl;
	return ret;
}*/
...
int hookedWydropienieBroni(int var1, int var2, float var3)
{
	...
	if (czy_customDrops_enabled) { //&& czyJoined
		if (czy_customDrops_config) {
			...
			if (wylosowana_liczba <= dchance) {
				int weapon = 19;
				if(czy_customPickups_enabled && !czy_customPickups_config) weapon = (std::rand() % 19);
...
int hookedStrzal(int var1, int var2)
{
	...
	//if (wdamage != -1) zwrot = strzal(var1, wdamage); else {
		if (pfmlayer) zwrot = strzal(var1, 12);
			...
			zwrot = strzal(var1, 305);
		}
		else if (betaGrenade) {
			zwrot = strzal(var1, 302);
		}
			...
			zwrot = strzal(var1, 86);
		}
		else if (singlerocket) {
			zwrot = strzal(var1, 459); //295
			*((short*)0x106D1BBE) -= 1;
		}
		...
		if (airStrikeWith == var2 && czy_customWeapons) {
			int czy_w_wodzie = *((int*)0x00ADC09C);
			if (czy_w_wodzie == 0){
				short* ammo = getAmmo(airStrikeAmmoId);
	...
	//}
	cout << "Strzal zwrot: " << hex << zwrot << dec << endl << endl;
	return zwrot;                                        //before returning to normal execution of function
}
...
int hookedIndamage1(int var1, int var2, int var3)
{
	...
	std::cout << "Indamage1 var3: " << var3 << std::endl << endl; //pocisk/efekt
	int zwrot = 0;
	...
	if (var1 != 0x106d1250) {
		...
		else if (var3 == 459) zwrot = indamage1(var1, 16, 14);
		else if (var3 == 305) zwrot = indamage1(var1, 26, 305);
		else if (var3 == 302) zwrot = indamage1(var1, 30, 302); 
		else if (var3 == 295) zwrot = indamage1(var1, 31, 295); //betaScorpion - singlerocket
		else zwrot = indamage1(var1, var2, var3);

		//cout << "Indamage1 zwrot: " << zwrot << endl << endl;
		return zwrot;
	}
	//if (wdamage != -1) zwrot = indamage1(var1, 10, 9);else {
		...
		else if (pfmlayer || sunfirepod || razor || cbore || usypiacz || flare || var3 == flareToFire || singlerocket || assault || betaGrenade || crossbow) zwrot = indamage1(var1, indmg1var2, indmg1var3);
		/*else if (czyPiorun) {
	...
	if (czy_customPickups_enabled) { //&& czyJoined
		//if (czy_customPickups_config) {
			...
			if (wylosowana_liczba <= pchance) {
				...
				if (rweapon == 31) {
					//singlerocket
					*((byte*)0x106D1BE1) = (byte)1;
					rweapon = 1;
				}else if (rweapon == 26) {
					//assault
					*((byte*)0x106D1BDC) = (byte)1;
					rweapon = 1;
				}else if (rweapon == 30) {
					//betaGrenade
					*((byte*)0x106D1BE0) = (byte)1;
					rweapon = 1;
				}
...
void serverRules() {
	...
	if (czy_ServerBot && lvlSet.find("beta08.lsm") == std::string::npos && lvlSet.find("beta084.lsm") == std::string::npos && lvlSet.find("beta09.lsm") == std::string::npos) {
...
void zmianka() {
	...
	//23=flare 34==raptor claws 16=rocketLauncher 11=firestorm 10=plasma 9=shredder 8=shotgun 2=non-zoomBow 3=tekbow 4=pistol 5=magnum 7=charge 0=talon 1=warblade 15=grenade 20=flame 22=nuke 24=crossbow 26=assault 31=singlerocket
	//30=betaGrenade 29=betaCbore 28=betaFirestorm 27=betaPlasma 25=betaChargedart 
	if (var == 15 && pfmlayer
		|| var == 5 && sunfirepod
		|| var == 10 && razor
		|| var == 7 && czyPiorun
...
//0x0041F2EA;  mov eax, [0x00AD0280] //poniżej tego jest wrapping-jumpbug, powyżej tego jest stuckbug
//0x0041F46F; mov eax, [0x00AD0280] //poniżej tego jest wrapping-jumpbug, powyżej tego jest stuckbug
//0x0041F5CA mov ax, [ebp + 0x00000A30] //poniżej tego jest wrapping-jumpbug

//0x0041F6C8 mov[ebp + 000000D4], eax //powyżej tego jest wrapping-jumpbug
//0x0041F7A9; mov eax, [0x0054BF90] //powyżej tego jest wrapping-jumpbug
//0x0041F99D; lea edi, [ebp + 0x00000A68] //powyżej tego jest wrapping-jumpbug
...
DWORD WINAPI custom_weapons(LPVOID lpParam) {
	while (1) {
		...
		if (strzelRidingGun) {
			...
			strzelFlare = false;
			strzal(0x106d1250, flareToFire);
		}
		else if (strzelPlasma) {
			strzelPlasma = false;
			strzal(0x106d1250, flareToFire);
		}
	}
...
DWORD WINAPI readServersCfg(LPVOID lpParam) {
	...
	while (loop) {
		...
		else if (slowo == ("cloudsSpeed=") == 0) {
			float f = stof(line.substr(line.find("=") + 1));
			WriteToMemory((LPVOID)0x0050B808, &f, sizeof(f));
		}
		else if (slowo == ("pickablesSpeed=") == 0) {
			float f = stof(line.substr(line.find("=") + 1));
			WriteToMemory((LPVOID)0x004F9724, &f, sizeof(f));
		}
		else if (slowo == "customBulletSpeed=") {
			float f = stof(line.substr(line.find("=") + 1));
			WriteToMemory((void*)0x00B64D70, &f, sizeof(f));
...
DWORD WINAPI Main_thread(LPVOID lpParam)
{
	...
	string version = "B0.9";
	cout << "T2 kub's mod " << version << ".2 (wip)" << endl;
	...
	dodaj_customPickup(18, 31, 10);
	dodaj_customPickup(18, 26, 100);
	customPchance[5] = 20;
	...
	if (!config) //if (config.good() == true)
	{
		...
		bool setDefaultBulletSpeed = false;
		bool fHooks = true;
		while (getline(config, wiersz)) {
			slowo = wiersz.substr(0, wiersz.find("=") + 1);
			//cout << slowo << endl;
			...
			else if (slowo == "MinFrameTime=") {
				string num = wiersz.substr(wiersz.find("=") + 1);
				minFrameTime = ::atoi(num.c_str());
			}
			else if (slowo == "MaxFrameRate=") {
				string num = wiersz.substr(wiersz.find("=") + 1);
				float f = ::atof(num.c_str());
				minFrameTime = round(1000/f);
			}
			else if (slowo == "FixGameSpeed=") {
				string num = wiersz.substr(wiersz.find("=") + 1);
				if (::atoi(num.c_str()) == 0) {
					fixGameSpeed = false;
				}
			}
			else if (slowo == "FixJumpRegistration=") {
				string num = wiersz.substr(wiersz.find("=") + 1);
				if (::atoi(num.c_str()) == 0) {
					fixJumpReg = false;
				}
			}
			else if (slowo == "FovOffset=") {
				string num = wiersz.substr(wiersz.find("=") + 1);
				double d = ::atof(num.c_str());
				WriteToMemory((LPVOID)0x004F94C8, &d, sizeof(d));
			}
			else if (slowo == "WeaponSize=") {
				string num = wiersz.substr(wiersz.find("=") + 1);
				weaponsize = ::atof(num.c_str());
				WriteToMemory((LPVOID)0x004F9790, &weaponsize, sizeof(weaponsize));
			}
			else if (slowo == "WeaponSize2=") {
				string num = wiersz.substr(wiersz.find("=") + 1);
				weaponsize2 = ::atof(num.c_str());
				WriteToMemory((LPVOID)0x004F9A80, &weaponsize2, sizeof(weaponsize2));
			}
			else if (slowo == "SetWeaponSize=") {
				string num = wiersz.substr(wiersz.find("=") + 1);
				float f = ::atof(num.c_str());
				weaponsize2 = f*0.1000000015;
				WriteToMemory((LPVOID)0x004F9A80, &weaponsize2, sizeof(weaponsize2));
			}
			else if (slowo == "WeaponFOV2=") {
				string num = wiersz.substr(wiersz.find("=") + 1);
				float f = ::atof(num.c_str());
				WriteToMemory((LPVOID)0x004F9A7C, &f, sizeof(f));
			}
			else if (slowo == "WeaponFOV3=") {
				string num = wiersz.substr(wiersz.find("=") + 1);
				float f = ::atof(num.c_str());
				WriteToMemory((LPVOID)0x004F9A78, &f, sizeof(f));
			} 
			else if (slowo == "BulletSpeed=") {
				string num = wiersz.substr(wiersz.find("=") + 1);
				float f = ::atof(num.c_str());
				WriteToMemory((void*)0x00B64D70, &f, sizeof(f));
				setDefaultBulletSpeed = false;
			}
			else if (slowo == "EnableCustomBulletSpeed=") {
				string num = wiersz.substr(wiersz.find("=") + 1);
				if (::atoi(num.c_str()) >= 1) {
					WriteToMemory((void*)0x0046149C, "\xD8\x0D\x70\x4D\xB6\x00", 6); //thx to that you can set bullet/particless speed via 00B64D70 variable
					setDefaultBulletSpeed = true;
				}
			}
			else if (slowo == "FixedF=") {
				string num = wiersz.substr(wiersz.find("=") + 1);
				fixedF = ::atof(num.c_str());
			}
			else if (slowo == "FHooks=") {
				string num = wiersz.substr(wiersz.find("=") + 1);
				if (::atoi(num.c_str()) == 0) {
					fHooks = false;
				}
		...
		if (setDefaultBulletSpeed) {
			float temp = 0.06855555;
			WriteToMemory((void*)0x00B64D70, &temp, sizeof(temp));
		}
		if (fHooks) {
	...
	//std::thread serverCfg(readServersCfg, cfgurl); serverCfg.join();
	...
	if(minFrameTime>=0)
		WriteToMemory((LPVOID)0x00B65F70, &minFrameTime, sizeof(minFrameTime));
	if (camerafov1 >= 90) {
	...
	delete[] writable;
	if (motd != "") {
		char * writable = new char[motd.size() + 1];
		strcpy(writable, motd.c_str());
		komunikat(writable);
		delete[] writable;
	}
...
BOOL APIENTRY DllMain(HANDLE hModule, DWORD dwReason, LPVOID lpReserved)
{
	if (dwReason == DLL_PROCESS_ATTACH)
	{
		...
		TeamChangeHook = (int_1int_)DetourFunction((PBYTE)0x485EB0, (PBYTE)hookedTeamChange); //int(__cdecl* TeamChangeHook)(int int1); //int __cdecl sub_485EB0(int)
		respawn = (int_1int_)DetourFunction((PBYTE)0x425F50, (PBYTE)hookedRespawn); //int(__cdecl* respawn)(int int1); //int __cdecl sub_425F50(int)
		changeChar = (int_1int_)DetourFunction((PBYTE)0x486040, (PBYTE)hookedChangeChar); //int(__cdecl* changeChar)(int int1); //int sub_4246B0(void); //int __cdecl sub_4245E0(int); //int __cdecl sub_4195D0(int); int __cdecl sub_486040(int);
		//zmiananickuHook = (int(__cdecl*)())DetourFunction((PBYTE)0x482220, (PBYTE)hookedZmiananicku); //int(__cdecl* zmiananicku)(); //int sub_482220()
		//zmianaKoloru = (int_1int_)DetourFunction((PBYTE)0x486100, (PBYTE)hookedZmianaKoloru); //int(__cdecl* zmianaKoloru)(int int1); //int __cdecl sub_486100(int)
		...
		//hitOrMiss1 = (int_1int_)DetourFunction((PBYTE)0x41FD20, (PBYTE)hookedHitOrMiss1);	//int __cdecl sub_41FD20(int); 0x41FD20 
		//hitOrMiss2 = (int_1int_)DetourFunction((PBYTE)0x461420, (PBYTE)hookedHitOrMiss2);	//int __cdecl sub_461420(int); 0x461420
		//hitOrMiss3 = (int_1int_)DetourFunction((PBYTE)0x45B060, (PBYTE)hookedHitOrMiss3); //int __cdecl sub_45B060(int);
		//hit = (int_1int_)DetourFunction((PBYTE)0x45C9E0, (PBYTE)hookedHit); //int __cdecl sub_45C9E0(int);
		//miss = (int_1int_)DetourFunction((PBYTE)0x45D140, (PBYTE)hookedMiss); //int __cdecl sub_45D140(int);
		//hitOrMiss4 = (int_1int_)DetourFunction((PBYTE)0x45B350, (PBYTE)hookedHitOrMiss4); //int __cdecl sub_45B350(int);
